            ...
            <ul class="nav navbar-nav side-nav">
                ...
                <li>
                    ...
                    <ul id="acciones" class="collapse">
                        <li>
                            <a href="{{URL::to('admin/usuarios/participantes')}}"><i class="fa fa-fw fa-edit"></i> Participantes </a>
                        </li>
                        <li>
                ...
                <li>
                    <a href="#" data-toggle="collapse" data-target="#prestamos"> Recetas <i class="fa fa-fw fa-caret-down"></i></a>
                    <ul id="prestamos" class="collapse">
                        <li>
                            <a href="{{URL::to('admin/recetas/recetas')}}"><i class="fa fa-fw fa-edit"></i>Ver recetas</a>
                        </li>
                        <li>
                            <a href="{{URL::to('admin/recetas/votaciones')}}"><i class="fa fa-fw fa-edit"></i>Votaciones</a>
                        </li>
                    </ul>
                </li>
                <li>
